...
def create_and_start_container(image, name):
    try:
        container = client.containers.create(image, name=name, detach=True, stdin_open=True)
        print()
...
def show_menu():
    print()
    print('Menu')
    print('1: Show containers')
    print('2: Create container')
    print('3: Delete container')
    print('4: Delete all containers')
    print('5: Show images')
    print('6: Pull image')
    print('7: Delete image')
    print('8: Delete all images')
    print('9: Quit')
    print()
...
#         if option == 1:
#             get_all_containers()
#             backOrQuit = back_or_quit()
#         elif option == 2:
#             image = input('Input the image name: ')
#             name = input('Input the container name: ')
#             create_and_start_container(image, name)
#             backOrQuit = back_or_quit()
#         elif option == 3:
#             pass
#         elif option == 9:
